...
document.addEventListener('DOMContentLoaded', function() {
 ...
 $('.popup-youtube, .popup-vimeo, .popup-gmaps').magnificPopup({
   ...
   function makeTimer() {
	var endTime = new Date("14 March 2025 23:59:00 GMT+01:00");			
	...
	if (timeLeft <= 0) {
	  timerElement.addClass("expired");
	  countdownElement.html(
		' Ưu đãi này đã kết thúc, hãy đợi ưu đãi mới trong thời gian tới bạn nhé!'
	  );
	} else {
	  timerElement.removeClass("expired");
